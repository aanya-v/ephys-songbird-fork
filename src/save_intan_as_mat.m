...
% goes through directory of Intan files and saves as .mat
%
% Adapated by Lyndie on 1/31/20 from read_Intan_RHD2000_file
%
...
% Save variables.
save(savename,'notes','frequency_parameters');
...
disp(['file ',num2str(g),'/',num2str(size(files,2))])
